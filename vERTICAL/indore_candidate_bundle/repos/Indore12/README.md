...
If you deploy the frontend to Netlify, this repo includes a helper build script:

```bash
pnpm run build:netlify
```

It runs API client codegen from `lib/api-spec/openapi.yaml` and then builds the `artifacts/indilingo` app.
