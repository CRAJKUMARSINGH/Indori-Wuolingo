import { useGetStatsOverview, useListProgress, useGetLeaderboard, useGetMe, getGetStatsOverviewQueryKey, getListProgressQueryKey, getGetLeaderboardQueryKey, getGetMeQueryKey } from "@workspace/api-client-react";
...
export default function Home() {
  ...
  const { data: progress, isLoading: progressLoading } = useListProgress({ userId: me?.userId }, { query: { enabled: !!me?.userId, queryKey: getListProgressQueryKey({ userId: me?.userId }) } });
