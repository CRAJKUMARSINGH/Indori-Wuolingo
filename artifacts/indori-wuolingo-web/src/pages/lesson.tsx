...
import { useGetLesson, useSubmitAnswer, useUpdateProgress, getGetLessonQueryKey, useGetMe, getGetMeQueryKey } from "@workspace/api-client-react";
  ...
  const handleCheck = async () => {
    ...
    try {
      const result = await submitAnswer.mutateAsync({
        id: exercise.id,
        data: { answer: selectedAnswer, userId: me?.userId }
      });
