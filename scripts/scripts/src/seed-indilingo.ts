...
const LANGUAGES: LanguageSeed[] = [
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Marathi", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'एक'?", "1", ["2", "3", "4"]), mc("What is 'पाच'?", "5", ["3", "7", "9"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Bengali", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'এক'?", "1", ["2", "3", "5"]), mc("What is 'পাঁচ'?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Gujarati", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'એક'?", "1", ["2", "3", "5"]), mc("What is 'પાંચ'?", "5", ["3", "7", "9"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Tamil", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'ஒன்று' (Ondru)?", "1", ["2", "3", "5"]), mc("What is 'ஐந்து' (Aindhu)?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Telugu", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'ఒకటి' (Okati)?", "1", ["2", "3", "5"]), mc("What is 'అయిదు' (Aidu)?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Punjabi", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'ਇੱਕ' (Ikk)?", "1", ["2", "3", "5"]), mc("What is 'ਪੰਜ' (Panj)?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Malayalam", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'ഒന്ന്' (Onnu)?", "1", ["2", "3", "5"]), mc("What is 'അഞ്ച്' (Anchu)?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Kannada", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'ಒಂದು' (Ondu)?", "1", ["2", "3", "5"]), mc("What is 'ಐದು' (Aidu)?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Odia", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'ଗୋଟିଏ' (Gotie)?", "1", ["2", "3", "5"]), mc("What is 'ପାଞ୍ଚ' (Pancha)?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Assamese", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'এক' (Ek)?", "1", ["2", "3", "5"]), mc("What is 'পাঁচ' (Panch)?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Urdu", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'ایک' (Ek)?", "1", ["2", "3", "5"]), mc("What is 'پانچ' (Paanch)?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Kashmiri", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'اَکھ' (Akh)?", "1", ["2", "3", "5"]), mc("What is 'پانژ' (Paanz)?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Nepali", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'एक' (Ek)?", "1", ["2", "3", "5"]), mc("What is 'पाँच' (Paanch)?", "5", ["3", "7", "10"])] }] },
  ...
  },
  {
    ...
    units: [
      ...
      { title: "Numbers", description: "Count in Sindhi", unitType: "vocabulary", lessons: [{ title: "1 to 10", xpReward: 10, exercises: [mc("What is 'ھڪ' (Hik)?", "1", ["2", "3", "5"]), mc("What is 'پنج' (Panj)?", "5", ["3", "7", "10"])] }] },
